...
content=Path('/home/tuan/.openclaw/workspace/tmp/web-20260823-0900-tang-lung.html').read_text()
title='Thang Máy Gia Đình Cho Nhà Có Tầng Lửng: 6 Điểm Cần Tính Trước Khi Lắp'
slug='thang-may-gia-dinh-cho-nha-co-tang-lung'
excerpt='Thang máy gia đình cho nhà có tầng lửng cần tính 6 điểm: điểm dừng, cao độ sàn, khoảng đứng, chiều cao thông thủy, tải trọng và bảo trì.'
seo=[
 {'key':'_yoast_wpseo_focuskw','value':'thang máy gia đình cho nhà có tầng lửng'},
 {'key':'_yoast_wpseo_metadesc','value':'Thang máy gia đình cho nhà có tầng lửng cần tính 6 điểm: điểm dừng, cao độ sàn, khoảng đứng, chiều cao thông thủy, tải trọng và bảo trì.'},
 {'key':'_yoast_wpseo_title','value':'Thang máy gia đình cho nhà có tầng lửng: 6 điểm cần tính'},
]
