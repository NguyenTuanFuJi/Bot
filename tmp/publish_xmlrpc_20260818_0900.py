...
content=Path('/home/tuan/.openclaw/workspace/tmp/web-20260818-0900.html').read_text()
title='Thang Máy Gia Đình Chống Nóng: 6 Điểm Cần Tính Từ Khi Thiết Kế'
slug='thang-may-gia-dinh-chong-nong-6-diem-can-tinh'
excerpt='Thang máy gia đình chống nóng cần chốt 6 điểm về hướng nắng, thông gió, vật liệu cabin, chống ẩm, nguồn điện và checklist vận hành.'
seo=[
 {'key':'_yoast_wpseo_focuskw','value':'thang máy gia đình chống nóng'},
 {'key':'_yoast_wpseo_metadesc','value':'Thang máy gia đình chống nóng cần chốt 6 điểm về hướng nắng, thông gió, cabin, chống ẩm, nguồn điện và vận hành an toàn.'},
 {'key':'_yoast_wpseo_title','value':'Thang máy gia đình chống nóng: 6 điểm cần tính'},
]
